...
source "$SYSINIT_ROOT"/deps/shell-lib/lib/logging.sh
source "$SYSINIT_ROOT"/deps/shell-lib/lib/os.sh
source "$SYSINIT_ROOT"/deps/shell-lib/lib/utils.sh
source "$SYSINIT_ROOT"/deps/shell-lib/lib/file.sh
